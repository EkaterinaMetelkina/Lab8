...
public class URLPool {
    ...
    // Метод достает первую пару ссылка-глубина из связанного списка с необработанными ссылками. Если список пуст
    ...
    /**
     * Метод добавляет пару Ссылка-глубина в конец списка необработанных ссылок и
    ...
    // Метод проверяет, была ли пара ссылка-глубина уже просмотрена
